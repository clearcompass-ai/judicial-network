...
// ─────────────────────────────────────────────────────────────────────
// GET /v1/judicial/monitoring/anchor-freshness — 501 stub
// ─────────────────────────────────────────────────────────────────────

// CheckAnchorFreshness needs a *witness.TreeHeadClient — federation-side
// dep that's not on Dependencies. Wired in C6 alongside topology/anchor
// federation.
...
func (h *monAnchorFreshnessHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	writeError(w, http.StatusNotImplemented,
		"anchor freshness requires *witness.TreeHeadClient injection; wired in C6")
}
