...
DESCRIPTION:
	...
	using verifier.VerifyDelegationProvenanceWithTrust (v1.34+) —
	the entry carries a slice of Header.DelegationPointers, and the
	verifier confirms that explicit chain. That mechanic is unchanged.
